...
# Use redis (valkey) for Action Cable
gem "redis"
...
# There isn't a straightforward way for an engine to have an isolated importmap.
# This allows for isolating JS to each engine.
